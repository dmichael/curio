...
Status: implemented in Curio 0.1.

This document defines the first installable version of Curio. Later packaging
and update work is listed separately so it does not expand the first build.
