...
Kept Arweave works remain available through Curio's AR.IO gateway. Curio protects selected data from its ordinary cache eviction policy and serves it under the original transaction or manifest path.
